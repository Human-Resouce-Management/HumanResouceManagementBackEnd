        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuanLy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BoPhanChuQuanId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoPhan_BoPhan_BoPhanChuQuanId",
                        column: x => x.BoPhanChuQuanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapBat = table.Column<int>(type: "int", nullable: true),
                    MucLuong = table.Column<double>(type: "float", nullable: true),
                    HeSo = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Modifiedby = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NghiCoLuong = table.Column<bool>(type: "bit", nullable: true),
                    NhanVienId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NguoiXacNhanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NgayKetThuc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SoGioNghi = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Modifiedby = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PhuCap_NhanVien_NhanVienId",
                        column: x => x.NhanVienId,
                        principalTable: "NhanVien",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeSoCu = table.Column<double>(type: "float", nullable: false),
                    HeSoMoi = table.Column<double>(type: "float", nullable: false),
                    NgayKetThuc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TangLuong", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TangLuong_NhanVien_NhanVienId",
                        column: x => x.NhanVienId,
                        principalTable: "NhanVien",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NhanVienId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NgayNghi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DaThoiViec = table.Column<bool>(type: "bit", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Modifiedby = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThoiViecs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ThoiViecs_NhanVien_NhanVienId",
                        column: x => x.NhanVienId,
                        principalTable: "NhanVien",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MucLuong = table.Column<double>(type: "float", nullable: true),
                    CacKhoangTru = table.Column<int>(type: "int", nullable: true),
                    NhanVienId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CacKhoangThem = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Modifiedby = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TinhLuong", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TinhLuong_NhanVien_NhanVienId",
                        column: x => x.NhanVienId,
                        principalTable: "NhanVien",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoPhan_BoPhanChuQuanId",
                table: "BoPhan",
                column: "BoPhanChuQuanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NhanVienTangCa_NhanVienId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TangLuong_NhanVienId",
                table: "TangLuong",
                column: "NhanVienId");

            migrationBuilder.CreateIndex(
                name: "IX_ThoiViecs_NhanVienId",
                table: "ThoiViecs",
                column: "NhanVienId");

            migrationBuilder.CreateIndex(
                name: "IX_TinhLuong_NhanVienId",
                table: "TinhLuong",
                column: "NhanVienId");
        }
